...
\be
	P(x^{(r)}\;|\;z_r, \sigma_x) = \prod_{n=s(r)}^{e(r)} \text{Normal}\Big(x_n\;\Big|\; x_{r,0} + f_r(t_n) \mu_{r,1} + g_r(t_n)\mu_{r,2}\Big)
\ee
...
\ba
	...
	\mathcal{B} &=& \frac{1}{\sigma_x^2} Sb + m \\
